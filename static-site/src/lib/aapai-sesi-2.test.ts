...
describe("bank soal AAPAI Sesi 2", () => {
  it("memuat 90 soal dengan topik, empat opsi unik, satu kunci, dan pembahasan", () => {
    const markdown = readFileSync(join(process.cwd(), "data", "aapai-sesi-2.md"), "utf8");
